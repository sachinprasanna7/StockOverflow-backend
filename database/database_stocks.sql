...
CREATE TABLE user_account (
    ...
    demat_number VARCHAR(50) UNIQUE NOT NULL,
    client_number VARCHAR(50) UNIQUE NOT NULL,
    bank_account_number VARCHAR(30) NOT NULL,
    ifsc_code VARCHAR(15) NOT NULL,
    trading_account_money DECIMAL(15,2) DEFAULT 0.00,
    stock_investments_money DECIMAL(15,2) DEFAULT 0.00
);
...
INSERT INTO user_account (
    ...
    bank_account_number,
    ifsc_code,
    trading_account_money,
    stock_investments_money
) VALUES (
    'Santhosh Kumar',
    'santhosh.kumar@gmail.com',
    '+91-9876543210',
    '1985-07-15',
    '12/3, Nehru Street, Muthialpet',
    '605003',
    'Pondicherry',
    'DM123456789012',
    'CL987654321098',
...
ALTER TABLE order_history MODIFY order_id INT NOT NULL AUTO_INCREMENT;
